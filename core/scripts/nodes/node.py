...
def list_nodes():
    ...
    print(f"{'Name':<15} {'Type':<10} {'IP / Domain':<25} {'Port':<8} {'SNI':<20} {'Insecure':<10} {'OBFS':<20} {'Pin SHA256'}")
...
def main():
    ...
    add_parser.add_argument(
        ...
        default='standard',
        help='Optional: Node type (standard or premium). Default: standard.'
    )
